    ...
    <div className='relative w-full h-[8rem] bg-[#8529cd] text-[#fff] text-[2rem]'>
      <div className='px-[2rem] py-[2rem]'>
        <ul className='flex items-center justify-between cursor-pointer '>
            ...
            <li className='hover:text-[#ff9900] hover:font-extrabold' onClick={()=>handleClick("Samsung")}>
                Samsung
            </li>
            ...
            <li className='hover:text-[#ff9900] hover:font-extrabold' onClick={()=>handleClick("Google")}>
                Google
            </li>
            <li className='hover:text-[#ff9900] hover:font-extrabold' onClick={()=>handleClick("Nokia")}>
                Nokia
            </li>
        </ul>
      </div>
