  ...
  return (
    <div className='w-full min-h-[40rem] bg-white shadow-2xl rounded-2xl'>
        <div className='w-full flex flex-col gap-[0.5rem]'>
            <div className='w-full flex justify-between items-center px-[2rem]  h-[8rem]  text-[white] text-[2rem] bg-[#8529cd]'>
                <div className='flex items-center gap-[2rem]'>
                  <BsFillBookmarkStarFill className='text-[3rem] text-[#fff]'/>
